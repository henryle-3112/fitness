...
public class ReplyOnProductFeedbackReactionController {
     ...
     */
    public ReplyOnProductFeedbackReactionController(
            ReplyOnProductFeedbackReactionService replyOnProductFeedbackReactionService) {
    ...
    public ReplyOnProductFeedbackReaction addReplyOnProductFeedbackReaction(
            @RequestBody ReplyOnProductFeedbackReaction replyOnProductFeedbackReaction) {
    ...
    @ResponseBody
    public List<ReplyOnProductFeedbackReaction> getReplyOnProductFeedbackReactions(
