...
public class ProductFeedbackController {
    ...
    /**
     * @param productFeedback - product's feedback that user want to update
     * @return updated product's feedback
     */
    ...
    public ProductFeedback updateProductFeedback(@RequestBody ProductFeedback productFeedback) {
        return this.productFeedbackService.updateProductFeedback(productFeedback);
    }
}
