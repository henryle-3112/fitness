...
public class CoachPaymentController {
     ...
     * @return list of coach payment histories
     */
    private List<CoachPayment> getCoachPaymentHistoriesPaging(HttpServletResponse response,
                                                              Integer coachId,
                                                              Integer userProfileId, String month,
                                                              String year,
                                                              Integer page) {
        ...
        int nPages = nCoachPaymentHistories > 0 ? (nCoachPaymentHistories >= Constants.NUMBER_ITEMS_PER_PAGE ? nCoachPaymentHistories / Constants.NUMBER_ITEMS_PER_PAGE : 1) : 0;
