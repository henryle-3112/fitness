...
public interface PostCommentRepository extends JpaRepository<PostComment, Long> {
    ...
    String GET_POST_COMMENTS = "select * from " + Constants.POST_COMMENT_TABLE + "" + " where (:postId is null and "
            + Constants.POST_TABLE + "." + Constants.POST_ID + " = :postId)" + " and (:postCommentStatus is null or "
            + Constants.POST_COMMENT_TABLE + "." + Constants.POST_COMMENT_STATUS + " = :postCommentStatus)";
    ...
    List<Object> getPostComments(Integer postId, Integer postCommentStatus);
