...
public interface CoachMembershipNotificationRepository extends JpaRepository<CoachMembershipNotification, Long> {
     ...
     */
    CoachMembershipNotification findCoachMembershipNotificationByUserProfileAndCoachAndStatus(UserProfile userProfile,
                                                                                              Coach coach,
                                                                                              int status);
     ...
     * @return selected coach membership notification
     */
    CoachMembershipNotification findCoachMembershipNotificationByUserProfileAndCoach(UserProfile userProfile,
                                                                                     Coach coach);
}
