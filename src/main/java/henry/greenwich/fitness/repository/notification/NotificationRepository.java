...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    String GET_NOTIFICATIONS_BY_PAGE = "select * from " + Constants.NOTIFICATION_TABLE + "" +
            " where (:userProfileId is null or " + Constants.NOTIFICATION_TABLE + "." + Constants.NOTIFICATION_USER_PROFILE_ID + " = :userProfileId)" +
            " and (:notificationContentKeywords is null or lower(" + Constants.NOTIFICATION_TABLE + "." + Constants.NOTIFICATION_CONTENT + ") like %:notificationContentKeywords%)" +
    ...
    /**
     * @param userProfileId               - user's profile's id that user want to get notifications (this parameter could be optional)
     * @param notificationContentKeywords - notification's content's keywords that user want to get notifications (this parameter could be optional)
    ...
    /**
     * @param userProfileId               - user's profile's id that user want to get number of notifications (this parameter could be optional)
     * @param notificationContentKeywords - notification's content's keywords that user want to get number of notifications (this parameter could be optional)
