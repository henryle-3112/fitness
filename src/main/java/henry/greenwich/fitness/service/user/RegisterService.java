...
public class RegisterService {
     ...
     */
    public RegisterService(UserAccountService userAccountService, UserProfileService userProfileService,
            UserAccountStatusService userAccountStatusService, BCryptPasswordEncoder bCryptPasswordEncoder,
            EmailServiceImpl emailService, RoleService roleService, UserRoleService userRoleService) {
