...
public class ReplyOnNewFeedCommentReactionService {
     ...
     */
    public ReplyOnNewFeedCommentReactionService(
            ReplyOnNewFeedCommentReactionRepository replyOnNewFeedCommentReactionRepository,
            UserProfileService userProfileService, ReplyOnNewFeedCommentService replyOnNewFeedCommentService) {
    ...
    private ReplyOnNewFeedCommentReaction getReplyOnNewFeedCommentReaction(Long userProfileId,
        ...
        return this.getReplyOnNewFeedCommentReactionsFromObjectList(replyOnNewFeedCommentReactionObjectList).get(0);
    }
