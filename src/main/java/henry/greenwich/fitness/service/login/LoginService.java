...
public class LoginService {
     ...
     */
    public LoginService(FacebookAccountService facebookAccountService,
    ...
    private void registerGoogleAccount(HttpServletResponse response, GoogleAccount googleAccount) {
        ...
        if (insertedGoogleAccount != null) {
            Role role = this.getRoleByName("ROLE_USER");
            if (role != null) {
                UserRole insertedUserRole = this.insertUserRole(role, insertedUserProfile, userProfileKey);
     ...
     */
    private UserRole insertUserRole(Role role, UserProfile insertedUserProfile, UserProfileKey userProfileKey) {
